...
The car is built around a simple mechanical transmission. The **spiral spring** is connected to a **spring gear**, which transfers rotational motion to the rest of the gear train. The gear train then drives the **wheel axle**, making the wheels rotate. A **pawl/ratchet mechanism** is included to control the spring gear and prevent unwanted reverse rotation.

The model was designed with **3D printability** in mind. The car is split into multiple printable components, such as the **chassis plates**, **gears**, **wheels**, **spring**, **pawl**, **knob**, and **body panels**. This makes the parts easier to print separately and assemble afterwards. Some non-moving parts can be glued together, while the moving components are designed with clearances and tolerances so they can rotate properly after printing.

The final design also includes a simple **car body shell**. The body shell is not only decorative, but also helps the model look like a finished toy car while still keeping the mechanical system partially visible, so the way it works can be understood more easily.

---

## Components and Their Purpose

The car is built from several 3D printable components. Each part was designed separately in order to make the model easier to print, assemble, and test. The main structure is based on two side chassis plates, a spring-driven gear mechanism, wheels, and a simple car body shell.

| Component | Purpose |
| --- | --- |
| **Left Chassis Plate** | The left chassis plate is one of the main structural parts of the car. It supports the axles, gears, and moving parts from one side and helps keep the mechanism aligned during motion. |
| **Right Chassis Plate** | The right chassis plate is placed parallel to the left one. Together, the two chassis plates hold the internal mechanism in position and provide stability for the whole assembly. |
| **Chassis Spacers** | The spacers keep a fixed distance between the left and right chassis plates. This creates enough clearance for the gears, axles, spring, and wheels to rotate without rubbing against the chassis. |
| **Spiral Spring** | The spiral spring is used to store mechanical energy when it is twisted. When released, it transfers rotational motion to the spring gear. |
| **Spring Gear** | The spring gear is connected to the spiral spring and acts as the first gear in the transmission system. It transfers the motion from the spring to the rest of the gear train. |
| **Pawl ** | The pawl works with the ratchet-style teeth of the spring gear. Its role is to control the direction of rotation and prevent the gear from rotating backwards unintentionally. |
| **Middle Gear** | The middle gear transfers motion between the spring gear and the gear mounted on the wheel axle. It helps continue the transmission of rotation through the mechanism. |
| **Axle Gear** | The axle gear receives motion from the gear train and transfers it directly to the wheel axle. This makes the wheels rotate together with the driven axle. |
| **Wheel Axle** | The wheel axle connects the wheels and allows them to rotate together. It is one of the final parts of the transmission system, converting the gear movement into wheel movement. |
| **Drive Wheels** | The wheels are responsible for the movement of the car. They receive rotation from the axle and transform it into forward motion. |
| **Knob / Crank Handle** | The knob is used to manually interact with the mechanism. It can be rotated by hand in order to tension or drive the spring mechanism. |
| **Side Body Panels** | The side body panels create the exterior shape of the car. They are designed as separate printable parts and can be attached to the chassis after the mechanism is assembled. |
| **Upper Body Cover** | The upper body cover connects the side panels and completes the car shell. It gives the model a cleaner and more finished appearance. |
| **Car Body Shell** | The body shell gives the project the appearance of a complete toy car while still allowing the internal mechanical system to remain partially visible. |
